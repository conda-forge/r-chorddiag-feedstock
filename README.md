...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-chorddiag-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8540&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-chorddiag-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-chorddiag` can be installed with:

```
conda install r-chorddiag
```

It is possible to list all of the versions of `r-chorddiag` available on your platform with:
